...
import dappSolidityContract from "./contracts/dappSolidity.json";
...
class App extends Component {
  state = { solidityfile: [], web3: null, accounts: null, contract: null };
  ...
  componentDidMount = async () => {
    try {
      ...
      const deployedNetwork = dappSolidityContract.networks[networkId];
      const instance = new web3.eth.Contract(
        dappSolidityContract.abi,
  ...
  getFiles = async () => {
    try {
      ...
      this.setState({ solidityfile: files });
    } catch (error) {
     console.log(error);
    }
  };
      ...
      <div className="App">
        <div className="container pt-3">
          ...
          <Table>
            ...
            <tbody>
              {solidityfile !== [] ? solidityfile.map((item, key)=>(
                <tr>
                <th>
                  <FileIcon
                    size={30}
